...
################################################################################
# Universal MySQL Backup Script with GFS Retention
# Compatible with both macOS and Ubuntu/Linux
#
# Auto-detects MySQL installation and adjusts paths accordingly
################################################################################

# Configuration
DB_NAME="receipt_app"
DB_USER="root"
DB_PASSWORD="List1you@"  # TODO: Use environment variable in production
...
if [[ "$OSTYPE" == "darwin"* ]]; then
    ...
    if [ -d "/usr/local/mysql-9.5.0-macos15-x86_64/bin" ]; then
